...
const TYPE_LABELS: Record<string, string> = {
  ...
  missing_dnssec: "DNSSEC not enabled",
  dnssec_misconfigured: "DNSSEC misconfigured",
  caa_incomplete: "CAA policy incomplete",
  weak_dmarc_policy: "Weak DMARC policy",
  weak_spf_policy: "Weak SPF policy",
  spf_lookup_limit_exceeded: "SPF lookup limit exceeded",
  multiple_spf_records: "Multiple SPF records",
  missing_mta_sts: "Missing MTA-STS",
  mta_sts_misconfigured: "MTA-STS not enforcing",
  missing_tls_rpt: "Missing SMTP TLS reporting",
  nameserver_misconfigured: "Nameserver misconfiguration",
  soa_misconfigured: "SOA timers out of range",
  dns_misconfiguration: "DNS misconfiguration",
  zone_transfer_allowed: "Zone transfer allowed",
  dangling_dns: "Dangling DNS record",
  weak_tls_version: "Deprecated TLS protocol",
  weak_cipher_suite: "Weak cipher suite",
  no_forward_secrecy: "No forward secrecy",
  tls_vulnerability: "TLS vulnerability",
  tls_misconfiguration: "TLS misconfiguration",
  certificate_untrusted: "Untrusted certificate",
  certificate_lifetime_excessive: "Certificate lifetime too long",
  certificate_transparency_missing: "Not in Certificate Transparency",
  missing_ocsp_stapling: "OCSP stapling not enabled",
  ...
  weak_security_header: "Weak security header",
  ...
  security_txt_missing: "No security.txt",
  sensitive_data_exposed: "Sensitive data exposed",
  debug_endpoint_exposed: "Debug endpoint exposed",
...
const TYPE_ICONS: Record<string, IconName> = {
  ...
  no_forward_secrecy: "key",
  tls_vulnerability: "alert",
  tls_misconfiguration: "certificate",
  certificate_untrusted: "certificate",
  certificate_lifetime_excessive: "certificate",
  certificate_transparency_missing: "certificate",
  missing_ocsp_stapling: "certificate",
  ...
  weak_security_header: "shield",
  insecure_cookies: "link",
  cors_misconfiguration: "link",
  dangerous_http_method: "link",
  mixed_content: "link",
  missing_sri: "link",
  security_txt_missing: "shield",
  sensitive_data_exposed: "eye",
  debug_endpoint_exposed: "alert",
  directory_listing: "eye",
  ...
  dnssec_misconfigured: "globe",
  caa_incomplete: "globe",
  weak_dmarc_policy: "globe",
  weak_spf_policy: "globe",
  spf_lookup_limit_exceeded: "globe",
  multiple_spf_records: "globe",
  missing_mta_sts: "globe",
  mta_sts_misconfigured: "globe",
  missing_tls_rpt: "globe",
  nameserver_misconfigured: "server",
  soa_misconfigured: "server",
  dns_misconfiguration: "globe",
  zone_transfer_allowed: "alert",
  dangling_dns: "alert",
